...
> **R:Porque al realizar #include el preprocesador incluye estas bibliotecas las cuales tienen su propio codigo. **
...
> **R: Los comentarios en el codigo se omiten a la hora de compilar **
...
> **R: Proviene de la biblioteca incluida stdio.h **
...
> **R: Se crea el stack frame de la funcion y se incrementa el valor de _llamadas en uno  **
...
> **R:Porque esta definido en matematica.o mientras que en programa.o solo la referencian, no es definida ahi **
...
> **R: Son funciones de la biblioteca dinámica del sistema que se cargan en tiempo de ejecucion. **
...
> **R: la macro funcion diria que ni es una funcion. Es mas una declaracion que reemplaza los valores previo a compilar. Como dice su declaracion #define. 
    Por su parte la funcion real tiene tipos de dato y es un codigo ejectable. **
...
> **R: 
Recordamos primero que T son las funciones definidas, es decir codigo ejecutable. Y D son las variables globales inicializadas.
Se las puede diferenciar a T por ser instrucciones de ejecucion mientras que D son los datos variables globales que se utilizan. 
Los T estan en la seccion .text y los D en .data (razon de su nombre y descripcion)
**
